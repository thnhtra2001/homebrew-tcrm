class TcrmDesktopInstaller < Formula
  ...
  homepage "https://github.com/thnhtra2001/tcrm_desktop_installer"
  url "https://github.com/thnhtra2001/tcrm_desktop_installer/releases/download/v1.0.0/tcrm_desktop_installer.tar.gz"
